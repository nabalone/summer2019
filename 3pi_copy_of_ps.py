...
SPECIFIED = [SOURCEDIR + '/ps1hosts/psc330128.3.fits',
             SOURCEDIR + '/ps1hosts/psc330128.4.fits',
             SOURCEDIR + '/ps1hosts/psc330128.5.fits']
RANGE = (985, 1900)
...
#        csvwriter = csv.writer(magdestfile)
    ...
    for filename in filenames:
        ...
        filter_letter = {3:'g', 4:'r', 5:'i', 6:'z'}
        template_filename = "3pi_hosts/ps_%s.%s.fits" % (idNumString, filterNum)
        query_3pi.run(float(eventRa), float(eventDec), filter_letter[filterNum], template_filename)
        continue
