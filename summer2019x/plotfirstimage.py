...
DESTDIR = os.getcwd() + '/allfounds'
THRESH = 3
SUBTRACT_BACKGROUND = False

    
for filename in ['C:/Users/Faith/Desktop/noey2019summer/ps1hosts/psc000014.3.fits']:
    ...
    im = ax.imshow(data_sub, interpolation='nearest', cmap='gray', vmin = 0, vmax = 1000)
